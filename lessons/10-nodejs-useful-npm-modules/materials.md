...
It is suitable for implementing components such as reverse proxies and load balancers.
...
![](http://chaijs.com/public/img/chai-logo.png)
...
Supports all JS coverage use cases including unit tests, server side functional tests.
