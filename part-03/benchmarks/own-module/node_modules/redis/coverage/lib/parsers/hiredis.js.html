...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (reply &amp;&amp; reply.constructor === Error) {
<span class="cstat-no" title="statement not covered" >            this.send_error(reply);</span>
        } else {
